      ...
      <section id="why-choose" className="py-32 bg-brand-black px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1px bg-white/5 border border-white/5">
            <div className="p-12 border border-white/5 md:col-span-2 lg:col-span-1 bg-brand-gold flex flex-col justify-center">
              ...
              <p className="text-black/80 text-sm font-bold uppercase tracking-widest leading-relaxed italic">
                The standard for luxury automotive experiences in NYC & NJ.
              </p>
            </div>
            
            {[
              { title: "FULLY INSURED", icon: <Shield size={32} />, desc: "Comprehensive insurance on every vehicle for peace of mind." },
              { title: "DOT COMPLIANT", icon: <CheckCircle size={32} />, desc: "Licensed and fully regulated according to US laws." },
              ...
              { title: "CONCIERGE DELIVERY", icon: <Truck size={32} />, desc: "Premier delivery service across the tri-state area." }
            ].map((item, i) => (
      ...
      <section className="py-32 bg-brand-dark overflow-hidden relative border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center mb-20">
            <span className="text-brand-gold text-xs font-black tracking-[0.5em] uppercase mb-4 block font-mono italic">CLIENT_REVIEWS</span>
            <h2 className="text-6xl md:text-8xl font-black italic uppercase italic tracking-tighter leading-none">
              RATED <span className="text-brand-gold italic">5 STARS</span>
            </h2>
          </div>

          <div className="flex overflow-x-auto gap-8 pb-12 snap-x px-4 scrollbar-hide">
             {[
               { n: "Anthony R.", t: "Absolutely fantastic service! The Range Rover was immaculate. Concierge delivery made it so easy." },
               { n: "Sarah M.", t: "Best car rental in NYC. Professional team and the Lamborghini was a dream to drive!" },
               { n: "David K.", t: "Rented a Mercedes S-Class for an event. Punctual, polite, and the car was spotless." },
               ...
               >
                 <div className="mb-12 flex gap-1">
                   {[...Array(5)].map((_, i) => <div key={i} className="w-4 h-4 bg-brand-gold"></div>)}
                 </div>
